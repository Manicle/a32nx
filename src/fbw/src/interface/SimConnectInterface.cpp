...
bool SimConnectInterface::prepareSimDataSimConnectDataDefinitions() {
  ...
  result &= addDataDefinition(hSimConnect, 0, SIMCONNECT_DATATYPE_FLOAT64, "ENG N1 RPM:1", "PERCENT");
  result &= addDataDefinition(hSimConnect, 0, SIMCONNECT_DATATYPE_FLOAT64, "ENG N1 RPM:2", "PERCENT");
